...
p_lv <- plot(b_satisfaction_outcome_results, pars = 6:11, plot.type = "areas", showplot = FALSE,
             prob = 0.8,
             prob_outer = 0.95) + 
...
scale_y_discrete(
    labels = c(
    "satisfaction~enforcement_sensitivity" = "Enforcement\nAcceptance",
    "satisfaction~upkeep_sensitivity" = "Quality Improvement\nAcceptance",
    "satisfaction~WITNESSED_CRIME" = "Witnessed\nCrime",
    "satisfaction~WITNESSED_NUIS" = "Witnessed\nNuisance",
    "satisfaction~WOM_SOC_CRIME" = "WOM/Soc. Med\nCrime",
    "satisfaction~WOM_SOC_NUIS" = "WOM/Soc. Med\nNuisance",
    "satisfaction~TRAD_CRIME" = "Trad. Media\nCrime",
    "satisfaction~TRAD_NUIS" = "Trad. Media\nNuisance",
    "satisfaction~mode_CTA_RAIL" = "CTA Rail",
    "satisfaction~mode_CTA_BUS" = "CTA Bus",
    "satisfaction~mode_METRA" = "Metra",
    "satisfaction~age" = "Age",
    "satisfaction~num_vehicles" = "Num. Vehicles",
    "satisfaction~income" = "Income",
    "satisfaction~gender_Female" = "Female"
  )) +
labs(title = "Regression coefficient estimates of covariates on satisfcation")

ggsave("../figures/cov_reg_post.png", dpi=200)
...
ggsave("../figures/mimic_loadings.png", dpi=300)
...
ggsave("../figures/mimic_exp_enf.png", dpi=300)
...
ggsave("../figures/mimic_upk.png", dpi=300)

color_scheme_set("orange")
p_dists_lv_causes_race <- plot(o
  b_satisfaction_outcome_results,
  pars = 9:11,
  plot.type = "areas",
  prob = 0.8,
...
ggsave("../figures/mimic_race.png", dpi=300)
...
ggsave("../figures/mimic_multi.png", plot = multi_mimic, dpi=300)
...
ggsave("../figures/mimic_multi_cols.png", plot = multi_mimic_cols, dpi=300)
...
ggsave("../figures/mimic_multi_cols_flipped.png", plot = multi_mimic_cols_flipped, dpi=300)
...
ggsave("../figures/reg_lvs.png", dpi=300)
...
ggsave("../figures/reg_mode.png", dpi=300)
...
ggsave("../figures/reg_sociodem.png", dpi=300)
...
ggsave("../figures/reg_exp.png", dpi=300)
...
ggsave("../figures/lv_reg_post.png", dpi=200)
...
ggsave("../figures/indicator_loadings.png")
...
#ggsave("../figures/regression_trace_plot.png", dpi=200)
...
ggsave("../figures/lv_means_hist.png", width=8, height=4, dpi=250)
...
ggsave("../figures/qi_sens_inc_veh.png", dpi=300, width = 8, height = 8)
...
ggsave("../figures/ppc_sat_dens.png", dpi=300)
...
ggsave("../figures/ppc_hist.png", dpi=300)